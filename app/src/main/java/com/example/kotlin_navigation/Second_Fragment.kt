...
import kotlinx.android.synthetic.main.fragment_second_.view.*
...
class Second_Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.textview2.setOnClickListener{ Navigation.findNavController(view).navigate(R.id.action_second_Fragment_to_first_Fragment3)}
        return view
    }
